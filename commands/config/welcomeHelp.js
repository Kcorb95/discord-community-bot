      ...
      fields: [
        {
          ...
          value: 'In order to do this, type `privatemessage <message>` or `publicmessage <message>`, where `message` is what the user will see when they join. In order to include a user mention. type `[user]` where the mention would go. If I picked this up, I will say `USER` in the feedback.'
        },
        {
          name: '**Step 2**: Provide a channel',
          value: 'If you want *public* welcome messages, read this. Type `welcomechannel <channel>` to give the public welcome message a place to go.'
        },
        {
