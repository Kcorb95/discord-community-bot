  ...
  async run(msg) {
    ...
    return msg.embed({
      ...
      description: stripIndents`
			...
			The current interest rate is ${(interestRate * 100).toFixed(2)}%.
			Interest will be applied in ${moment.duration(nextUpdate, 'milliseconds').format('hh [hours] mm [minutes] ss [seconds]')}.`
    });
  }
};